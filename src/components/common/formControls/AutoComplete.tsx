...
export default function AutoComplete({
  ...
  const filtered = options.filter(option => new RegExp(search, "i").test(option));
  ...
  return (
    ...
    <div className={"auto-complete" + (className ? ` ${className}` : "")}>
      <label className="auto-complete__label">
        ...
        <input value={search} onChange={e => setSearch(e.currentTarget.value)} className="auto-complete__control" {...inputProps} />
