...
export default function JordanOne() {
	return (
		...
		<div className="product-view">
			<div className="product-view__gallery"> {/* TODO: Should be own gallery component */}
				<div className="product-view__images">
					<ul>
						<li>
							<button>
								{/* <Image src="" width={80} height={60} /> */}
							</button>
						</li>
					</ul>
				</div>
				<div className="product-view__picture">
					<div className="product-view__picture-container">
						<div className="product-view__gallery-controls">
							<button className="gallery__prev"><MdArrowBackIos /></button>
							<button className="gallery__next"><MdArrowForwardIos /></button>
						</div>
						{/* <Image src="" /> */}
					</div>
